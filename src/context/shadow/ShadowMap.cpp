...
void ShadowMapBase::BuildShadersAndInputLayout()
{
	...
	m_Shaders["standardVS"] = D3DUtil::CompileShader(SourcePath() + L"/Shaders/ShadowMapBase.hlsl", nullptr, "VS", "vs_5_1");
	m_Shaders["opaquePS"] = D3DUtil::CompileShader(SourcePath() + L"/Shaders/ShadowMapBase.hlsl", nullptr, "PS", "ps_5_1");
	m_Shaders["alphaTestedPS"] = D3DUtil::CompileShader(SourcePath() + L"/Shaders/ShadowMapBase.hlsl", alphaTestDefines, "PS", "ps_5_1");
}
...
void ShadowMapBase::BuildTextureResourceView()
{
	//build resouce view
