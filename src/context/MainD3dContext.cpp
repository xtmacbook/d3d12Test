...
void MainD3DContext::BuildShadersAndInputLayout()
{
	...
	m_vsByteCode = D3DUtil::CompileShader(SourcePath() +  L"Shaders/color.hlsl", nullptr, "VS", "vs_5_1");
	m_psByteCode = D3DUtil::CompileShader(SourcePath() +  L"Shaders/color.hlsl", nullptr, "PS", "ps_5_1");
